...
class _SafeDayProgressIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final colors = context.colors;
    // double progress = 0.0; // TODO: Restore logic later
    double progress = 0.65; // Static Demo Value
